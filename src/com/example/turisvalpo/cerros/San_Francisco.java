...
public class San_Francisco extends ActiveLocationManagerActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_san__francisco);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.san__francisco, menu);
		return true;
	}
