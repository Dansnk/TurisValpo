...
public class Santa_Elena extends ActiveLocationManagerActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_santa__elena);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.santa__elena, menu);
		return true;
	}
