...
public class Sn_Juan_de_Dios extends ActiveLocationManagerActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_sn__juan_de__dios);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.sn__juan_de__dios, menu);
		return true;
	}
