...
public class Playa_Ancha extends ActiveLocationManagerActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_playa__ancha);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.playa__ancha, menu);
		return true;
	}
